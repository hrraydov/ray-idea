...
module.exports = function(app) {
	...
	// Show user
	app.route('/users/:username').get(users.show);

	// Avatar Routes
	app.route('/users/avatar').post(users.requiresLogin, users.uploadAvatar);

	// User skills api
	app.route('/users/:username/skills').get(users.getSkills);
